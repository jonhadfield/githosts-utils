...
//
// const (
// 	sourcehutCallSize           = 100
// 	sourcehutEnvVarCallSize     = "SOURCEHUT_CALL_SIZE"
// 	sourcehutEnvVarWorkerDelay  = "SOURCEHUT_WORKER_DELAY"
// 	sourcehutDomain             = "sourcehut.com"
...
// }
//
// func (gh *SourcehutHost) getAPIURL() string {
// 	return gh.APIURL
// }
//
...
// }
//
// type sourcehutQueryNamesResponse struct {
// 	Data struct {
// 		Viewer struct {
// 			Repositories struct {
// 				Edges    []edge
...
// }
//
// type sourcehutQueryOrgsResponse struct {
// 	Data struct {
// 		Viewer struct {
...
// }
//
// type sourcehutQueryOrgResponse struct {
// 	Data struct {
// 		Organization struct {
// 			Repositories struct {
// 				Edges    []edge
...
// }
//
// func (gh *SourcehutHost) makeGithubRequest(payload string) (string, errors.E) {
// 	contentReader := bytes.NewReader([]byte(payload))
//
// 	ctx, cancel := context.WithTimeout(context.Background(), defaultHttpRequestTimeout)
// 	defer cancel()
//
// 	req, newReqErr := retryablehttp.NewRequestWithContext(ctx, http.MethodPost, "https://api.sourcehut.com/graphql", contentReader)
//
// 	if newReqErr != nil {
...
// 	}
//
// 	req.Header.Set("Authorization", "bearer "+gh.OAuthToken)
...
// 			logger.Println("Sourcehut authorisation with fine grained PAT (Personal Access OAuthToken) failed as their GraphQL endpoint currently only supports classic PATs: https://github.blog/2022-10-18-introducing-fine-grained-personal-access-tokens-for-github/#coming-next")
//
// 			return "", errors.New("sourcehut authorisation with fine grained PAT (Personal Access OAuthToken) failed as their GraphQL endpoint currently only supports classic PATs: https://github.blog/2022-10-18-introducing-fine-grained-personal-access-tokens-for-github/#coming-next")
// 		}
//
...
// 	default:
// 		return "", errors.New("sourcehut authorisation failed")
// 	}
//
// 	return bodyStr, nil
// }
...
// func (gh *SourcehutHost) describeGithubUserRepos() ([]repository, errors.E) {
...
// }
//
// func (gh *SourcehutHost) describeGithubUserOrganizations() ([]githubOrganization, errors.E) {
// 	logger.Println("listing Sourcehut user's related Organizations")
//
...
// }
//
// func (gh *SourcehutHost) describeGithubOrgRepos(orgName string) ([]repository, errors.E) {
// 	logger.Printf("listing Sourcehut organization %s's repositories", orgName)
//
// 	gcs := gitHubCallSize
//
// 	envCallSize := os.Getenv(githubEnvVarCallSize)
...
// }
//
// func (gh *SourcehutHost) describeRepos() (describeReposOutput, errors.E) {
// 	var repos []repository
//
// 	if !gh.SkipUserRepos {
...
// 		if err != nil {
// 			logger.Print("failed to get user's Sourcehut organizations")
//
// 			return describeReposOutput{}, err
// 		}
//
...
// 		if err != nil {
// 			logger.Printf("failed to get Sourcehut organization %s repos", org)
//
// 			return describeReposOutput{}, errors.Wrapf(err, "failed to get Sourcehut organization %s repos", org)
// 		}
//
...
// }
//
// func (gh *SourcehutHost) Backup() ProviderBackupResult {
// 	if gh.BackupDir == "" {
...
// 		go gitHubWorker(gh.LogLevel, gh.OAuthToken, gh.BackupDir, gh.DiffRemoteMethod, gh.BackupsToRetain, gh.BackupLFS, jobs, results)
//
...
// func (gh *SourcehutHost) diffRemoteMethod() string {
